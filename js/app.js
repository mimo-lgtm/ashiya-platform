...
const GAS_URL = "https://script.google.com/macros/s/AKfycbz9BYdtfuoqz9rBBGtap-W8RBxOvuP9xwrfCzu6CP2d7mCdOmbSjztT_M5FxboN9spTng/exec";
...
// =====================================================================
// =========================================================
// app.js の loadLiveCivicVision 関数を丸ごとこれに置き換え
// =========================================================
...
async function loadLiveCivicVision() {
  ...
  try {
    ...
    liveText.innerHTML =
      ...
      '</div>' +
      (latest.reason
        ? '<div style="font-size:13px;background:#f0fdf4;border-radius:8px;' +
          'padding:10px 14px;border-left:3px solid #16a34a;line-height:1.7;color:#15803d;">' +
